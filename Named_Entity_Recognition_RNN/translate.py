...
tf.app.flags.DEFINE_integer("en_vocab_size", 64567, "English vocabulary size.")
tf.app.flags.DEFINE_integer("ner_vocab_size", 28, "NER vocabulary size.")
...
def create_model(session, forward_only):
  ...
  model = seq2seq_model.Seq2SeqModel(
      FLAGS.en_vocab_size, FLAGS.ner_vocab_size, _buckets,
...
def train():
  ...
  en_train, ner_train, en_dev, ner_dev, _, _ = data_utils.prepare_data(
      FLAGS.data_dir, FLAGS.en_vocab_size, FLAGS.ner_vocab_size)
  print (en_train, en_dev, ner_dev, ner_dev)
  with tf.Session() as sess:
    ...
    dev_set = read_data(en_dev, ner_dev)
    train_set = read_data(en_train, ner_train, FLAGS.max_train_data_size)
